...
app.config['MYSQL_DATABASE_PASSWORD'] = 'Alyne2023!@#'
app.config['MYSQL_DATABASE_DB'] = 'smartbatch'
app.config['MYSQL_DATABASE_HOST'] = '54.90.59.192'
...
class UserList(Resource):
    ...
    def post(self):
        try:
            ...
            _identificador = request.json['identificador']
            _valor = request.json['valor']
            insert_user_cmd = """INSERT INTO coletor_senai(mac, identificador, valor) 
                                VALUES(%s, %s, %s)"""
            cursor.execute(insert_user_cmd, (_mac, _identificador, _valor))
            conn.commit()
